  ...
  function kb(e, t, r, n, o, i, a, s, l, c, u, f) {
    ...
    if (i) {
      var b = e + r,
        x = i._isStart;
      (f = 'scroll' + n.d2),
        C(i, b, n, (x && 20 < b) || (!x && (u ? Math.max(Pe[f], _e[f]) : i.parentNode[f]) <= b + 1)),
        u && ((l = ot(a)), u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + tt));
    }
    return Math.round(e);
  }
  function mb(e, t, r, n) {
  ...
  var $ =
    ((ScrollTrigger.prototype.init = function init(y, w) {
      if (((this.progress = this.start = 0), this.vars && this.kill(1), De)) {
        ...
        (Se.media = Ie),
          ...
          (f.tweenScroll = f.tweenScroll || {top: nb(ge, nt), left: nb(ge, rt)}),
          ...
          pe &&
            (X(pe) || (pe = {snapTo: pe}),
            'scrollBehavior' in Pe.style && Ce.set(ve ? [Pe, _e] : ge, {scrollBehavior: 'auto'}),
            (l = V(pe.snapTo)
              ? pe.snapTo
              : 'labels' === pe.snapTo
          ...
          se &&
            ...
            (n = Ce.core.getCache(se)).spacer
              ? (F = n.pinState)
              : ((n.spacer = Y = ke.createElement('div')), Y.setAttribute('class', 'pin-spacer' + (i ? ' pin-spacer-' + i : '')), (n.pinState = F = hb(se))),
              ...
              if (se && e && Ye) Ba(ScrollTrigger, 'scrollEnd', Ua);
                ...
                for (
                  var t,
                    ...
                    g = y.end,
                    v = y.endTrigger || ae,
                    m = y.start || (0 !== y.start && ae ? (se ? '0 0' : '0 100%') : 0),
                ...
                if (((_ += d), (B += d), (Se._pinPush = h), E && d && (((t = {})[te.a] = '+=' + d), Ce.set([E, L], t)), se))
                  (t = sa(se)),
                    ...
                    me &&
                      (((i = {top: r.top + (o ? n - _ : l) + tt, left: r.left + (o ? l : n - _) + tt, boxSizing: 'border-box', position: 'fixed'})[Ge] = i.maxWidth = Math.ceil(r.width) + tt),
          ...
          (Se.update = function (e, t) {
            var r,
              ...
              u = Se.progress;
            if (
              (t && ((k = C), (C = s), pe && ((x = b), (b = w && !he ? w.totalProgress() : c))),
              ue && !c && se && !Le && !We && Ye && _ < s + ((s - k) / (He() - Ne)) * ue && (c = 1e-4),
              c !== u && Se.enabled)
            ) {
              if (
                ((i = (a = (r = Se.isActive = !!c && c < 1) != (!!u && u < 1)) || !!c != !!u),
                (Se.direction = u < c ? 1 : -1),
                (Se.progress = c),
                he || (!j || Le || We ? w && w.totalProgress(c, !!Le) : ((j.vars.totalProgress = c), j.invalidate().restart())),
                se)
              )
    ...
    (ScrollTrigger.register = function register(e) {
      if (
        !i &&
        ((Ce = e || L()),
        K() && window.document && ((Oe = window), (ke = document), (_e = ke.documentElement), (Pe = ke.body)),
        Ce && ((Be = Ce.utils.toArray), (Ee = Ce.utils.clamp), (Ue = Ce.core.suppressOverwrites || J), Ce.core.globals('ScrollTrigger', ScrollTrigger), Pe))
      ) {
        (s =
    ...
    (ScrollTrigger.config = function config(e) {
      ...
      (t && clearInterval(c)) || ((c = t) && setInterval(La, t)),
        'autoRefreshEvents' in e && (T(Ca) || T(Ba, e.autoRefreshEvents || 'none'), (r = -1 === (e.autoRefreshEvents + '').indexOf('resize')));
    }),
      ...
      for (r in e)
        (n = B.indexOf(r)),
          ...
          'all' === (Ie = r)
            ...
            : (t = Oe.matchMedia(r)) &&
              (t.matches && (i = o()),
              ~n ? ((B[n + 1] = Z(B[n + 1], o)), (B[n + 2] = Z(B[n + 2], i))) : ((n = B.length), B.push(r, o, i), t.addListener ? t.addListener(Ta) : t.addEventListener('change', Ta)),
              (B[n + 3] = t.matches)),
          (Ie = 0);
      return B;
    }),
