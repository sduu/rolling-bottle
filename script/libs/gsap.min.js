...
!(function (t, e) {
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!p) {
          ...
          for (p = v[d] = [], i = y ? Math.min(f, d) * T - 0.5 : m % f, n = y ? (d * w) / f - 0.5 : (m / f) | 0, l = j, u = h = 0; u < d; u++)
      ...
      return o(e) && (isNaN(e) || e in s)
        ? ((n = e.charAt(0)),
          ...
          '<' === n || '>' === n
            ...
            : i < 0
              ? (e in s || (s[e] = h), s[e])
              : ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))), a && r && (n = (n / 100) * (Z(r) ? r[0] : r).totalDuration()), 1 < i ? _parsePosition(t, e.substr(0, i - 1), r) + n : h + n))
        : null == e
          ? h
          : +e;
    },
  ...
  function Mk(t) {
    var e,
      ...
      s = !0 === t;
    if (
      (k < a && (C += a - A), (0 < (e = (i = (S += a) - C) - z) || s) && ((n = ++b.frame), (T = i - 1e3 * b.time), (b.time = i /= 1e3), (z += e + (D <= e ? 4 : D - e)), (r = 1)), s || (m = g(Mk)), r)
    )
    ...
    Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
      ...
      if (
        ...
        return isNaN(d * i) || '' === i
          ...
          : ((l = new ae(this._pt, t, e, +d || 0, i - (d || 0), 'boolean' == typeof f ? $t : Zt, 0, c)), h && (l.fp = h), s && l.modifier(s, this, t), (this._pt = l));
    },
    ...
    Vt = (function (C) {
      function Tween(e, r, i, n) {
        ...
        if (((a._targets = P.length ? $(P) : O('GSAP target ' + e + ' not found. https://greensock.com', !Y.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = T), w || b || v(m) || v(g))) {
          if (((r = a.vars), (o = a.timeline = new Nt({data: 'nested', defaults: x || {}})).kill(), (o.parent = o._dp = _assertThisInitialized(a)), (o._start = 0), w))
  ...
  function Bd(t, e, r, i) {
    ...
    return (
      ...
      Ee[e] && 'transform' !== e
        ? ((n = He(t, i)), (n = 'transformOrigin' !== e ? n[e] : n.svg ? n.origin : Ke(pd(t, Ye)) + ' ' + n.zOrigin + 'px'))
        : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) || (n = (Ve[e] && Ve[e](t, e, r)) || pd(t, e) || aa(t, e) || ('opacity' === e ? 1 : 0)),
  ...
  function Md(t, e, r, i, n, a) {
    var s,
      ...
      x = parseFloat(T[1]) || 0;
    r
      ? l !== We && (o = _ * v - m * g) && ((u = w * (-m / o) + x * (_ / o) - (_ * b - m * y) / o), (w = w * (v / o) + x * (-g / o) + (g * b - v * y) / o), (x = u))
      : ((w = (s = vd(t)).x + (~T[0].indexOf('%') ? (w / 100) * s.width : w)), (x = s.y + (~(T[1] || T[0]).indexOf('%') ? (x / 100) * s.height : x))),
      ...
      (t.style[Ye] = '0px 0px'),
      a && (yd(a, h, 'xOrigin', f, w), yd(a, h, 'yOrigin', d, x), yd(a, h, 'xOffset', p, h.xOffset), yd(a, h, 'yOffset', c, h.yOffset)),
  ...
  function Yd(t, e, r) {
    var i,
      ...
      f = r.style;
    for (n in (l.svg
      ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[Qe] = e), (i = He(r, 1)), xd(r, Qe), r.setAttribute('transform', a))
      : ((a = getComputedStyle(r)[Qe]), (f[Qe] = e), (i = He(r, 1)), (f[Qe] = a)),
    Ee))
      (a = l[n]) !== (s = i[n]) &&
        'perspective,force3D,transformOrigin,svgOrigin'.indexOf(n) < 0 &&
        ((o = Qa(a) !== (h = Qa(s)) ? Ad(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new ae(t._pt, i, n, o, u - o, _c)), (t._pt.u = h || 0), t._props.push(n));
    Xd(i, l);
  }
  var ue,
    he,
    ...
    He = function _parseTransform(t, e) {
      ...
      return (
        ...
        (r.svg = !(!t.getCTM || !wd(t))),
        (m = Ld(t, r.svg)),
        r.svg && ((k = (!r.uncache || '0px 0px' === L) && !e && t.getAttribute('data-svg-origin')), Md(t, k || L, !!k || r.originIsAbsolute, !1 !== r.smooth, m)),
        (c = r.xOrigin || 0),
        (_ = r.yOrigin || 0),
        m !== We &&
          ((b = m[0]),
          ...
          6 === m.length
            ...
            : ((F = m[6]),
              ...
              g &&
                ...
                (F = P)),
              (l = (g = Be(-w, D)) * Fe),
              g && ((v = Math.cos(-g)), (E = x * (y = Math.sin(-g)) + E * v), (b = k = b * v - C * y), (T = A = T * v - S * y), (w = P = w * v - D * y)),
              (u = (g = Be(T, b)) * Fe),
              g && ((k = b * (v = Math.cos(g)) + T * (y = Math.sin(g))), (A = O * v + M * y), (T = T * v - b * y), (M = M * v - O * y), (b = k), (O = A)),
              ...
              (p = E ? 1 / (E < 0 ? -E : E) : 0)),
          r.svg && ((k = t.getAttribute('transform')), (r.forceCSS = t.setAttribute('transform', '') || !Jd(pd(t, Qe))), k && t.setAttribute('transform', k))),
      ...
      (d = parseFloat(d)),
        ...
        d || p
          ? ((d *= Re),
            ...
            (n = Math.sin(d - p) * -m),
            (a = Math.cos(d - p) * m),
            p && ((c *= Re), (s = Math.tan(p - c)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), c && ((s = Math.tan(c)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
            (r = ca(r)),
            (i = ca(i)),
            (n = ca(n)),
            (a = ca(a)))
          : ((r = _), (a = m), (i = n = 0)),
        ((x && !~(l + '').indexOf('px')) || (O && !~(f + '').indexOf('px'))) && ((x = Ad(g, 'x', l, 'px')), (O = Ad(g, 'y', f, 'px'))),
          ...
          if ('autoRound' !== d && ((s = e[d]), !ft[d] || !Tb(d, e, r, i, t, n)))
            if (((l = typeof s), (f = Ve[d]), 'function' === l && (l = typeof (s = s.call(r, i, t, n))), 'string' === l && ~s.indexOf('random(') && (s = gb(s)), f)) f(this, t, d, s, r) && (b = 1);
              ...
              if (
                ...
                (u = parseFloat(s)),
                d in Ne &&
                  ('autoAlpha' === d && (1 === h && 'hidden' === Bd(t, 'visibility') && u && (h = 0), yd(this, w, 'visibility', h ? 'inherit' : 'hidden', u ? 'inherit' : 'hidden', !u)),
